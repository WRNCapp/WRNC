  ...
  return (
    <View testID="build-score-card" className="rounded-xl border border-wrnc-border bg-wrnc-background p-3" style={{ marginTop: 12 }}>
      <View className="flex-row items-end justify-between gap-3">
        ...
        <Text className="text-3xl font-bold text-wrnc-text-primary">{score}/100</Text>
      </View>
      <Text className="mt-2 text-xs font-medium text-wrnc-text-primary">{score} of 100 documentation points</Text>
      <View className="mt-2">
