const LOGO_URL =
  'https://raw.githubusercontent.com/GarageOSOfficial/WRNC/main/assets/brand/wrnc-master-logo-hyper-silver-transparent-placement.png';
const SOCIAL_URL =
  'https://raw.githubusercontent.com/GarageOSOfficial/WRNC/main/assets/brand/wrnc-master-logo-hyper-silver-080808.png';
...
<meta name="twitter:description" content="Every build deserves a living record. WRNC is building a purpose-built home for automotive Builders and their Builds." />
...
<body>
<main class="page">
<section class="hero" aria-labelledby="coming-soon-heading">
<img class="logo" src="${LOGO_URL}" alt="WRNC" width="226" height="50" decoding="async" fetchpriority="high" />
...
function sourceFromReferrer(value){if(!value||value==='direct')return'direct';try{var host=new URL(value).hostname.toLowerCase();if(host.indexOf('instagram.com')>=0)return'instagram';if(host.indexOf('tiktok.com')>=0)return'tiktok';if(host.indexOf('facebook.com')>=0||host.indexOf('fb.com')>=0)return'facebook';if(host.indexOf('youtube.com')>=0||host.indexOf('youtu.be')>=0)return'youtube';if(host.indexOf('reddit.com')>=0)return'reddit';if(host.indexOf('linktr.ee')>=0||host.indexOf('linktree')>=0)return'linktree';return host}catch(error){return'unknown'}}
})();
</script>
</body>
</html>`;
